<div class="products index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('prof');?></th>
	...
	<tr>
		...
		<td><?php echo h($product['Product']['altura']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['largura']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['prof']); ?>&nbsp;</td>
