...
//                debug($order);
    ...
    public function cancel($id = null) {
        ...
        if ($this->request->is('get')) {
            ...
            $this->request->data['Order']['cancelado'] = true;
            if ($this->Order->save($this->request->data)) {
                $this->Order->returnToStock();
                $this->Session->setFlash(__('Order canceled'));
                $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash(__('Order was not canceled'));
                $this->redirect(array('action' => 'index'));
            }
        }
    }
    ...
    public function sent($id = null) {
        ...
        $this->Order->id = $id;
        if ($this->Order->saveField('entregue', date('Y-m-d H:i:s'))) {
            $this->Session->setFlash(__('The order has been sent'));
            $this->redirect(array('action' => 'index'));
        }
    }
